            ...
            <main>
                ...
                <div className='aboutPage'>
                    ...
                    <div>
                        ...
                        <h3 className='pedroNome'>Pedro Isac</h3>
                    ...
                    <div>
                        ...
                        <h3 className='vitorNome'>Vitor Przybylski</h3>
                        <h4 className='vitorDesc'>Estudante do Jovem Programador, fez a estilização e as rotas das páginas</h4>
                    </div>
                    <div>
